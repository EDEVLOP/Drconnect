...
VisitingTrayModel visitingTrayModelFromJson(String str) => VisitingTrayModel.fromJson(json.decode(str));

String visitingTrayModelToJson(VisitingTrayModel data) => json.encode(data.toJson());
...
class VisitingTrayModel {
    ...
    factory VisitingTrayModel.fromJson(Map<String, dynamic> json) => VisitingTrayModel(
